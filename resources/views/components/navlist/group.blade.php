...
<details {{ $attributes->class('group/disclosure grid') }} {{ $expanded ? 'open' : '' }}>
    <summary class="mb-[2px] flex h-10 w-full items-center rounded-lg text-gray-500 cursor-default hover:bg-gray-800/5 hover:text-gray-800 lg:h-8">
        <div class="pl-3 pr-4">
    ...
    <div class="relative space-y-[2px] pl-7">
        <div class="absolute inset-y-[3px] left-0 ml-4 w-px bg-gray-200"></div>
        {{ $slot }}
    </div>
</details>
